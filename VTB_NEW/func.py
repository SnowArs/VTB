...
def outstanding_volume_price(ticker):
    ...
    if len(ticker.buy_volume_array) != 0:
        ...
        try:
            ticker.current_price = Calculations.get_current_price_usd(ticker.name)
            ...
            ticker.current_price = round(Calculations.get_current_price(ticker.name), 1)
        except IndexError:
        ...
        ticker.current_price = Calculations.get_current_price(ticker.name)
