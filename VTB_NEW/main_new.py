        ...
        if len(buy_arr) != 0:
            ...
            try:
                profit_for_outstanding_volumes = (get_current_price(ticker.name) - average_price_usd) \
                                                 * ticker.outstanding_volumes
                # profit_for_outstanding_volumes = check_ndfl(profit_for_outstanding_volumes)
                total_profit = int(profit_in_usd + check_ndfl(profit_for_outstanding_volumes))
